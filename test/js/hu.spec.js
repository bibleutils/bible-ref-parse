(function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle ranges (hu)", function() {
      ...
      return expect(p.parse("Phlm 2 KOV 3").osis()).toEqual("Phlm.1.2-Phlm.1.3", "parsing: 'Phlm 2 KOV 3'");
    });
    it("should handle chapters (hu)", function() {
      ...
      expect(p.parse("Titus 1:1, fej 2").osis()).toEqual("Titus.1.1,Titus.2", "parsing: 'Titus 1:1, fej 2'");
      return expect(p.parse("Matt 3:4 FEJ 6").osis()).toEqual("Matt.3.4,Matt.6", "parsing: 'Matt 3:4 FEJ 6'");
    });
    ...
    it("should handle 'and' (hu)", function() {
      ...
      return expect(p.parse("Phlm 2 VAGY 6").osis()).toEqual("Phlm.1.2,Phlm.1.6", "parsing: 'Phlm 2 VAGY 6'");
    });
    it("should handle titles (hu)", function() {
      ...
      return expect(p.parse("PS 3 CIM, 4:2, 5:CIM").osis()).toEqual("Ps.3.1,Ps.4.2,Ps.5.1", "parsing: 'PS 3 CIM, 4:2, 5:CIM'");
    });
    it("should handle 'ff' (hu)", function() {
      ...
      return expect(p.parse("REV 3 KK, 4:2 KK").osis()).toEqual("Rev.3-Rev.22,Rev.4.2-Rev.4.11", "parsing: 'REV 3 KK, 4:2 KK'");
    });
    ...
    it("should handle book ranges (hu)", function() {
      ...
      return expect(p.parse("Első kov Harmadik  Jn").osis()).toEqual("1John.1-3John.1", "parsing: 'Első kov Harmadik  Jn'");
    });
