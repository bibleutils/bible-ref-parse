(function() {
  ...
  describe("Miscellaneous tests", function() {
    ...
    it("should handle chapters (nl)", function() {
      ...
      return expect(p.parse("Matt 3:4 HOOFDSTUK 6").osis()).toEqual("Matt.3.4,Matt.6", "parsing: 'Matt 3:4 HOOFDSTUK 6'");
    });
    ...
    it("should handle 'and' (nl)", function() {
      ...
      return expect(p.parse("Phlm 2 ZIE OOK 6").osis()).toEqual("Phlm.1.2,Phlm.1.6", "parsing: 'Phlm 2 ZIE OOK 6'");
    });
    it("should handle titles (nl)", function() {
      ...
      return expect(p.parse("PS 3 OPSCHRIFT, 4:2, 5:OPSCHRIFT").osis()).toEqual("Ps.3.1,Ps.4.2,Ps.5.1", "parsing: 'PS 3 OPSCHRIFT, 4:2, 5:OPSCHRIFT'");
    });
    it("should handle 'ff' (nl)", function() {
      ...
      return expect(p.parse("REV 3 EN VOLGENDE VERZEN, 4:2 EN VOLGENDE VERZEN").osis()).toEqual("Rev.3-Rev.22,Rev.4.2-Rev.4.11", "parsing: 'REV 3 EN VOLGENDE VERZEN, 4:2 EN VOLGENDE VERZEN'");
    });
    ...
    it("should handle book ranges (nl)", function() {
      ...
      return expect(p.parse("Eerste - Derde  Joh").osis()).toEqual("1John.1-3John.1", "parsing: 'Eerste - Derde  Joh'");
    });
