...
// `translation` is a translation object, but all we care about is the string.
  ...
  bcv_parser.prototype.regexps.escaped_passage = RegExp(`(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014]|Titel(?![a-z])|und${bcv_parser.prototype.regexps.space // Beginning of string or not in the middle of a word or immediately following another book. Only count a book if it's part of a sequence: `Matt5John3` is OK, but not `1Matt5John3`
...
}+siehe${bcv_parser.prototype.regexps.space}+auch|sowie${bcv_parser.prototype.regexps.space}+auch|siehe${bcv_parser.prototype.regexps.space}+auch|und${bcv_parser.prototype.regexps.space}+siehe|und${bcv_parser.prototype.regexps.space}+auch|ff(?![a-z0-9äaöoüu])|f(?![a-z0-9äaöoüu])|Kapiteln|Kapiteln|Kapitel|Versen|Verses|siehe|sowie|Verse|Vers|Vers|Kap|bis|und|vgl|Vs|u|&|[a-e](?!\\w)|$)+)`, "gi");

  // These are the only valid ways to end a potential passage match. The closing parenthesis allows for fully capturing parentheses surrounding translations (ESV**)**. The last one, `[\d\x1f]` needs not to be +; otherwise `Gen5ff` becomes `\x1f0\x1f5ff`, and `adjust_regexp_end` matches the `\x1f5` and incorrectly dangles the ff.
  bcv_parser.prototype.regexps.match_end_split = /\d\W*Titel|\d\W*f(?![a-z0-9äaöoüu])(?:[\s\xa0*]*\.)?|\d\W*ff(?![a-z0-9äaöoüu])(?:[\s\xa0*]*\.)?|\d[\s\xa0*]*[a-e](?!\w)|\x1e(?:[\s\xa0*]*[)\]\uff09])?|[\d\x1f]/gi; //ff09 is a full-width closing parenthesis
  ...
  bcv_parser.prototype.regexps.get_books = function(include_apocrypha, case_sensitive) {
    ...
    books = [
      ...
      },
      {
        osis: ["Bel"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Bel(?:[\\s\\xa0]*und[\\s\\xa0]*(?:Vom[\\s\\xa0]*Drachen|der?[\\s\\xa0]*Drache))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Lev"],
      ...
      },
      {
        osis: ["PrMan"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Das[\\s\\xa0]*Gebet[\\s\\xa0]*(?:des[\\s\\xa0]*Manasse|Manasses)|Gebet[\\s\\xa0]*des[\\s\\xa0]*Manasse|Geb(?:et[\\s\\xa0]*Manasses|[\\s\\xa0]*Man)|Gebet[\\s\\xa0]*Manasse|(?:Or[\\s\\xa0]*|Pr)Man))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Deut"],
      ...
      {
        osis: ["Judg"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ri(?:ch(?:ter)?)?|Judg))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Ruth"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ru(?:th?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1Esd"],
      ...
      {
        osis: ["Ps"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ps(?:alm(?:en)?|lm)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["PrAzar"],
        apocrypha: true,
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Das[\\s\\xa0]*Gebet[\\s\\xa0]*(?:des[\\s\\xa0]*Asarja|Asarjas)|Gebet[\\s\\xa0]*(?:des[\\s\\xa0]*Asarja|Asarjas)|PrAzar|Geb[\\s\\xa0]*As))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Prov"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Spr(?:ichw(?:oe?|\\xF6)rter|(?:ue?|\\xFC)che)?|Prov))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Eccl"],
      ...
      {
        osis: ["Song"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:H(?:ohe(?:s(?:lied(?:[\\s\\xa0]*Salomo(?:ni)?s)?|[\\s\\xa0]*Lied)|lied(?:[\\s\\xa0]*Salomo(?:ni)?s)?)|ld)|Song))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jer"],
      ...
      {
        osis: ["Ezek"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Hes(?:ekiel|ek)?|Ez(?:e(?:chiel|k))?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Dan"],
      ...
      {
        osis: ["Mic"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Mi(?:c(?:h(?:a(?:eas|as)?|\\xE4as)?)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Nah"],
      ...
      {
        osis: ["Zeph"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Ze(?:ph(?:anja)?|f(?:anja)?)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Hag"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Hag(?:g(?:ai)?)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Zech"],
      ...
      {
        osis: ["Matt"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Das[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Matth(?:ae?|\\xE4)us|[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Matth(?:ae?|\\xE4)us|M(?:atth(?:ae?|\\xE4)usevangelium|att(?:h(?:ae?|\\xE4)us)?|t)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Mark"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Das[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Markus|[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Markus|M(?:arkusevangelium|ark(?:us)?|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Luke"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Das[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Lukas|[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Lukas|L(?:uk(?:asevangelium|e)|uk(?:as)?|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["1John"],
      ...
      {
        osis: ["John"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:Das[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Johannes|[\\s\\xa0]*Evangelium[\\s\\xa0]*nach[\\s\\xa0]*Johannes|Joh(?:annesevangelium|annes|n)?))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Acts"],
      ...
      {
        osis: ["Rom"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:R(?:o(?:em(?:er)?|m(?:er)?)|\\xF6m(?:er)?|m)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Cor"],
      ...
      {
        osis: ["Heb"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:H(?:eb(?:r(?:aee?r|\\xE4er)?)?|b)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["Jas"],
        regexp: RegExp(`(^|${bcv_parser.prototype.regexps.pre_book})((?:J(?:a(?:k(?:obus(?:brief)?)?|s)|k)))(?:(?=[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"'\\*=~\\-\\u2013\\u2014])|$)`,
      "gi")
      },
      {
        osis: ["2Pet"],
...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c65 = "kap",
        peg$c66 = peg$literalExpectation("kap", false),
        peg$c67 = "iteln",
        peg$c68 = peg$literalExpectation("iteln", false),
        peg$c69 = "itel",
        peg$c70 = peg$literalExpectation("itel", false),
        peg$c71 = function() { return {"type": "c_explicit"} },
        peg$c72 = "v",
        peg$c73 = peg$literalExpectation("v", false),
        peg$c74 = "ersen",
        peg$c75 = peg$literalExpectation("ersen", false),
        peg$c76 = "erses",
        peg$c77 = peg$literalExpectation("erses", false),
        peg$c78 = "erse",
        peg$c79 = peg$literalExpectation("erse", false),
        peg$c80 = "ers",
        peg$c81 = peg$literalExpectation("ers", false),
        peg$c82 = "s",
        ...
        peg$c91 = "und",
        peg$c92 = peg$literalExpectation("und", false),
        peg$c93 = "siehe",
        peg$c94 = peg$literalExpectation("siehe", false),
        peg$c95 = "auch",
        peg$c96 = peg$literalExpectation("auch", false),
        peg$c97 = "sowie",
        peg$c98 = peg$literalExpectation("sowie", false),
        peg$c99 = "u",
        peg$c100 = peg$literalExpectation("u", false),
        peg$c101 = "&",
        peg$c102 = peg$literalExpectation("&", false),
        peg$c103 = "vgl",
        peg$c104 = peg$literalExpectation("vgl", false),
        peg$c105 = function() { return "" },
        peg$c106 = /^[\-\u2013\u2014]/,
        peg$c107 = peg$classExpectation(["-", "\u2013", "\u2014"], false, false),
        peg$c108 = "bis",
        peg$c109 = peg$literalExpectation("bis", false),
        peg$c110 = "titel",
        peg$c111 = peg$literalExpectation("titel", false),
        peg$c112 = function(val) { return {type:"title", value: [val], "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c113 = "from",
        peg$c114 = peg$literalExpectation("from", false),
        peg$c115 = "of",
        peg$c116 = peg$literalExpectation("of", false),
        peg$c117 = "in",
        peg$c118 = peg$literalExpectation("in", false),
        peg$c119 = "the",
        peg$c120 = peg$literalExpectation("the", false),
        peg$c121 = "book",
        peg$c122 = peg$literalExpectation("book", false),
        peg$c123 = /^[([]/,
        peg$c124 = peg$classExpectation(["(", "["], false, false),
        peg$c125 = /^[)\]]/,
        peg$c126 = peg$classExpectation([")", "]"], false, false),
        peg$c127 = function(val) { return {"type": "translation_sequence", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c128 = "\x1E",
        peg$c129 = peg$literalExpectation("\x1E", false),
        peg$c130 = function(val) { return {"type": "translation", "value": val.value, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c131 = ",000",
        peg$c132 = peg$literalExpectation(",000", false),
        peg$c133 = function(val) { return {"type": "integer", "value": parseInt(val.join(""), 10), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c134 = /^[^\x1F\x1E([]/,
        peg$c135 = peg$classExpectation(["\x1F", "\x1E", "(", "["], true, false),
        peg$c136 = function(val) { return {"type": "word", "value": val.join(""), "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c137 = function(val) { return {"type": "stop", "value": val, "indices": [peg$savedPos, peg$currPos - 1]} },
        peg$c138 = /^[\s\xa0*]/,
