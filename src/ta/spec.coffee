...
describe "Miscellaneous tests", ->
	...
	it "should handle chapters (ta)", ->
		...
		expect(p.parse("Matt 3:4 அதி 6").osis()).toEqual("Matt.3.4,Matt.6", "parsing: 'Matt 3:4 அதி 6'")
	...
	it "should handle 'and' (ta)", ->
		...
		expect(p.parse("Phlm 2 மற்றும் 6").osis()).toEqual("Phlm.1.2,Phlm.1.6", "parsing: 'Phlm 2 மற்றும் 6'")
	...
	it "should handle book ranges (ta)", ->
		...
		expect(p.parse("முதலாவது to முன்றாம்  யோவான்").osis()).toEqual("1John.1-3John.1", "parsing: 'முதலாவது to முன்றாம்  யோவான்'")
