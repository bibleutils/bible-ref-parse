...
describe "Miscellaneous tests", ->
	...
	it "should handle 'and' (tl)", ->
		...
		expect(p.parse("Phlm 2 AT 6").osis()).toEqual("Phlm.1.2,Phlm.1.6", "parsing: 'Phlm 2 AT 6'")
	...
	it "should handle 'ff' (tl)", ->
		...
		expect(p.parse("REV 3 K, 4:2 K").osis()).toEqual("Rev.3-Rev.22,Rev.4.2-Rev.4.11", "parsing: 'REV 3 K, 4:2 K'")
	...
	it "should handle book ranges (tl)", ->
		...
		expect(p.parse("Unang - Ikatlong  Juan").osis()).toEqual("1John.1-3John.1", "parsing: 'Unang - Ikatlong  Juan'")
