...
describe "Miscellaneous tests", ->
	...
	it "should handle chapters (th)", ->
		...
		expect(p.parse("Matt 3:4 บทที่ 6").osis()).toEqual("Matt.3.4,Matt.6", "parsing: 'Matt 3:4 บทที่ 6'")
	...
	it "should handle 'and' (th)", ->
		...
		expect(p.parse("Phlm 2 และ 6").osis()).toEqual("Phlm.1.2,Phlm.1.6", "parsing: 'Phlm 2 และ 6'")
	...
	it "should handle book ranges (th)", ->
		...
		expect(p.parse("1 - 3  ยอห์น").osis()).toEqual("1John.1-3John.1", "parsing: '1 - 3  ยอห์น'")
