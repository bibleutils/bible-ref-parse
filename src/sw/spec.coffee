...
describe "Miscellaneous tests", ->
	...
	it "should handle ranges (sw)", ->
		...
		expect(p.parse("Phlm 2 HADI 3").osis()).toEqual("Phlm.1.2-Phlm.1.3", "parsing: 'Phlm 2 HADI 3'")
	it "should handle chapters (sw)", ->
		expect(p.parse("Titus 1:1, sura 2").osis()).toEqual("Titus.1.1,Titus.2", "parsing: 'Titus 1:1, sura 2'")
		expect(p.parse("Matt 3:4 SURA 6").osis()).toEqual("Matt.3.4,Matt.6", "parsing: 'Matt 3:4 SURA 6'")
	it "should handle verses (sw)", ->
		expect(p.parse("Exod 1:1 mistari 3").osis()).toEqual("Exod.1.1,Exod.1.3", "parsing: 'Exod 1:1 mistari 3'")
		expect(p.parse("Phlm MISTARI 6").osis()).toEqual("Phlm.1.6", "parsing: 'Phlm MISTARI 6'")
	...
	it "should handle book ranges (sw)", ->
		...
		expect(p.parse("Kwanza hadi Tatu  Yoh").osis()).toEqual("1John.1-3John.1", "parsing: 'Kwanza hadi Tatu  Yoh'")
